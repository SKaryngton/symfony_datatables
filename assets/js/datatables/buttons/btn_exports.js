        ...
        buttons: [
            {
                ...
                messageTop:' List of Employees',
                messageBottom:null,
                title:'Datatable Full',
                filename:'table',
                footer:true,
                exportOptions:{
                    columns:':visible'
...

            {
                ...
                customize: function( xlsx ) {
                    ...
                    // mettre la colonne c en gras ('s','2'):style index 2
                    $('row c[r^="C"]', sheet).attr( 's', '2' );

                    // Loop over the cells in column `C`
                    $('row c[r^="C"]', sheet).each( function () {
                        // Get the value
                        if ( $('is t', this).text() === 'Glover' ) {
                            //add background color to th cell
                            $(this).attr( 's', '20' );
                        }
                    });
                    // select all cells in row 10 to add  borders
